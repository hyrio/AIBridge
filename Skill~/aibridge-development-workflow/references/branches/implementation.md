...
1. 先确认项目偏好中实施分支已启用。
2. 修改前读取 `risk-gates.md` 和 `coding-rules.md`。
3. 涉及复杂一次性 Editor 侧 C# 任务时读取 `editor-generation.md`。
4. 只在当前任务确实需要时加载 `aibridge-code-index`、`aibridge-prefab-patch`、`unity-yaml-editing` 或 `aibridge-batch-script`。
